		...
		>
			<div className="chatbox-header relative flex items-center px-4 pt-4 pb-4 rounded-t-xl">
				...
				<button
					type="button"
					onClick={onClose}
					className="absolute right-3 top-3 w-7 h-7 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 border-none cursor-pointer text-gray-600 text-sm"
				>
					✕
				</button>
			</div>
			...
			>
				...
				<button
					...
					className="send-button w-9 h-9 flex items-center justify-center rounded-full text-white disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer border-none flex-shrink-0"
				>
					➤
				</button>
			</form>
